        ...
        do {
            ...
            for u in users {
                ...
                if (txtUsername.text == usn) && (txtPassword.text == psw){
                    ...
                    let userDictionary: [String: String] = ["user": usn]
                    if (appDelegate.foodConnect.sendData(dictionaryWithData: userDictionary, toPeer: appDelegate.foodConnect.session.connectedPeers[0] as MCPeerID)) {
